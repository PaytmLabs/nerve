...
class Rule:
  def __init__(self):
    ...
    self.rule_confirm = 'High Vulnerabilities Found'
    self.rule_details = ''
    self.rule_mitigation = '''Server has 1 or more High (>= 7.0 and <= 8.9) CVEs associated with its version.
