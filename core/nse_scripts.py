...
def save_result(script, result, metadata, ip, port, values):
  ...
  rds.store_vuln({
    ...
    'rule_confirm': metadata['confirm'],                     # Check, Descripción de algo, falta identificar de que, se puede dejar como strin      g vacío supongo
